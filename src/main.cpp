...
int main() {
	...
	int ascii_image_height = static_cast<int>(ascii_image_width * (height / static_cast<float>(width)));
	...
	//		ascii_from_luma(ascii_lumens[y * ascii_image_width + x]);
	//		//ascii_out << ascii_from_luma(ascii_lumens[y * ascii_image_width + x]);
	//		//ascii_out << ascii_lumens[y * ascii_image_width + x] << " ";
	//		std::cout << y * ascii_image_width + x << " --- " << ascii_lumens[y * ascii_image_width + x] << std::endl;
	//	}
	//	ascii_out << std::endl;
	//}

	float luma = ascii_lumens[308];
	std::cout << luma << std::endl;
	ascii_from_luma(luma);
